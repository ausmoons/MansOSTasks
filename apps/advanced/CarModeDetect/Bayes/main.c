...
//
// This is the network for CarMote publication
//
...
void appMain(void)
{
    ...
    for (;;) {
        ...
        int8_t fullBNVariables[TOTAL_STATES];
        fullBNVariables[MOVING] = NOT_SET;
        fullBNVariables[WAS_MOVING] = TRUE;
        fullBNVariables[PAST_BRAKE] = FALSE;
        fullBNVariables[PAST_ACCEL] = FALSE;
        fullBNVariables[ACCEL] = FALSE;
        fullBNVariables[SSD] = TRUE;
        fullBNVariables[MSD] = TRUE;
        fullBNVariables[LSD] = FALSE;
        fullBNVariables[DIFF] = FALSE;

        float prob = fullBNConditionalProbability(MOVING, fullBNVariables);
